...
export class App extends React.Component {
  ...
  getImageFromAPI = () => {
    return axios.get(`https://www.flickr.com/services/rest/?method=flickr.photos.search&api_key=73bdf4a0b75179e8e2e5d2108c85bfdc&tags=nature,landscape&tag_mode=all&page=${this.state.currentPageAPI}&per_page=1&extras=url_c&format=json&nojsoncallback=1`)
      .then(response => {
        this.setState({
